...
import { classNames } from "@/utilities/css-utilities";
    ...
    <footer className=" h-fit flex flex-col border-gray/40 border-t-[1.5px] bg-soothing_black text-white px-0 flex-wrap overflow-hidden">
      <div className="flex flex-wrap">
        <div className="border-gray/40 border-b-[1.5px] w-full lg:w-[22rem] lg:border-b-0 lg:border-r-[1.5px] flex flex-col p-10 min-w-[18rem] min-h-[14rem] items-start justify-center">
          ...
          <Link
            href="mailto:dashrishikesh900@gmail.com"
            className="font-chakra font-semibold italic text-2xl">
            bits2bytes@gmail.com
          </Link>
        </div>
        ...
        <div className="min-w-[18rem] grow-[1] text-white/70">
          ...
          <div>
            <div className="flex">
              <Link
                href="#"
                className="social-links flex items-center justify-center grow-[1] min-w-[5rem] min-h-[12rem] hover:text-youtubeColor hover:bg-white"
              >
                <FaYoutube size="3rem" />
              </Link>
              <Link
                href="#"
                className="social-links flex items-center justify-center grow-[1] min-w-[5rem] min-h-[12rem] hover:bg-gradient-to-r from-[#833ab4] via-[#fd1d1d] to-[#fcb045] hover:text-white"
              >
                <FaInstagram size="3rem" />
              </Link>
              <Link
                href="#"
                className="social-links flex items-center justify-center grow-[1] min-w-[5rem] min-h-[12rem] hover:bg-facebookColor hover:text-white"
              >
