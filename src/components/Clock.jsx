...
function Clock() {
  return (
    <div className="w-screen flex justify-center my-10 lg:mb-8">
      <div className="md:border px-3 border-gray/80 xl:mt-[8rem] pb-5 xl:pb-10 w-[100] xl:w-[35rem] flex flex-col justify-center items-center z-[10] text-white tracking-[1rem] font-clash">
        <Countdown date={new Date("2025-08-06T00:00:00")}
      ...
      <div className="hidden xl:block pl-4 border min-w-min-[3rem] border-gray/80 p-3 mt-[8rem] text-white">
