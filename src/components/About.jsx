    ...
    <div className="h-fit relative p-4 sm:p-6 md:p-8 lg:p-8 xl:p-10">
      ...
      <div className="font-chakra py-4 sm:py-6 md:py-8 lg:py-10 xl:py-12 space-y-4 sm:space-y-6 md:space-y-8">
        <span ref={aboutb2b} className="text-sm sm:text-base md:text-lg lg:text-xl text-white font-medium block">
          <b>BITS2BYTES</b>, the annual technical fest of our college Techno Bengal
          Institute of Technology, is more than just a celebration of technology, it
          is a legacy of innovation, creativity, and collaboration that has been
          thriving since <b>2006.</b> What began as a modest initiative has grown into
          a prestigious platform where aspiring technologists, problem-solvers, and
          innovators come together to showcase their talents and ideas.
          <br className="my-4" />
          Each edition of <b>BITS2BYTES</b> brings with it a fresh wave of energy and
          purpose — from intense coding competitions and hardware challenges to
          insightful tech talks and hands-on workshops. The fest provides students
          with an opportunity not only to test their skills but also to explore new
          technologies, share knowledge, and connect with like-minded peers.
          <br className="my-4" />
          More than a technical fest, <b>BITS2BYTES</b> represents the spirit of our
          college — a space where boundaries are pushed, ideas are brought to life,
